...
class forSaleProductDetails extends StatefulWidget {
  SaleProduct product;

  forSaleProductDetails(this.product);

  @override
  _forSaleProductDetailsState createState() =>
      _forSaleProductDetailsState(product);
}

/// Detail Product for Recomended Grid in home screen
class _forSaleProductDetailsState extends State<forSaleProductDetails> {
  double rating = 3.5;
  int starCount = 5;

  /// Declaration List item HomeGridItemRe....dart Class
  final SaleProduct product;
  _forSaleProductDetailsState(this.product);
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  // product.governorate == null
                                  //     ? '---'
                                  //     : product.governorate.title
                                  '',
                                  style: _txtCustomHead.copyWith(
                                      fontSize: 17.0,
                                      fontWeight: FontWeight.w600),

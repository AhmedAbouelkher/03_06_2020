...
class AuctionProductItemRow extends StatelessWidget {
  BaseProduct product;
  UserController _userController = UserController();
  VoidCallback onDeleteFromFavourite;
  AuctionProductItemRow({this.product, this.onDeleteFromFavourite});
  @override
    ...
    return Slidable(
      ...
      secondaryActions: <Widget>[
        new IconSlideAction(
          ...
          icon: Icons.delete,
          onTap: () {
            (product.favUsers as Map).remove(

                Provider.of<PhoneAuthDataProvider>(context,
                    listen: false).user.uid
                );

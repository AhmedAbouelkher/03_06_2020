...
class AuctionProductDetails extends StatefulWidget {
  ...
  AuctionProductDetails(this.auctionProduct);

  _AuctionProductDetailsState createState() =>
      _AuctionProductDetailsState(auctionProduct);
}
...
class _AuctionProductDetailsState extends State<AuctionProductDetails> {
  ...
  _AuctionProductDetailsState(this.product);
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    height: 50.0,
                    width: 1000.0,
                    color: ThemeColors.auctionProductTitleBar,
                    child: Row(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Padding(padding: EdgeInsets.only(top: 5.0)),
                          Text(
                            "تبدأ المزايدة من ${product.startPrice.toString()} ريال",
                            style: _customTextStyle.copyWith(
